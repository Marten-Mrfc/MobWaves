 ...
 */
fun setCustomValue(meta: ItemMeta, plugin: MobWaves, id: String, value: Any) {
 ...
 */
fun checkCustomValue(meta: ItemMeta, plugin: MobWaves, id: String, value: Any): Boolean {
    val key = NamespacedKey(plugin, id)
    return when (value) {
        is String -> {
 ...
 */
fun getCustomValue(meta: ItemMeta, plugin: MobWaves, id: String): Any? {
    val key = NamespacedKey(plugin, id)
    return when {
